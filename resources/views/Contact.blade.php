                  ...
                  <div class="mu-contact-left">
                    <form class="contactform">                  
                      <p class="comment-form-author">
                        ...
                        <input name="name" type="text" required="required" size="30" value="" name="author">
                      </p>
                      <p class="comment-form-email">
                        <label for="email">Email <span class="required">*</span></label>
                        <input name="email" type="email" required="required" aria-required="true" value="" name="email">
                      </p>
                      ...
                      <p class="comment-form-comment">
                        ...
                        <textarea name="message" required="required" aria-required="true" rows="8" cols="45" name="comment"></textarea>
                      </p>                
                      <p class="form-submit">
